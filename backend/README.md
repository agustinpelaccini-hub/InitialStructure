...
```bash
# Si estas en \GitHub\InitialStructure> , hacer: cd backend
python -m venv venv
source venv/bin/activate          # Linux/Mac
#  ./venv/Scripts/Activate.ps1    # Windows
# Si es la primera vez que corres esto, ejecutar: Set-ExecutionPolicy -Scope CurrentUser -ExecutionPolicy RemoteSigned -Force
